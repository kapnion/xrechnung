        ...
        <html>
            ...
            <body>
                ...
                <table>
                    ...
                    <tr><th>Betrag mit Steuern</th><td><xsl:value-of select="ubl:Invoice/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount" /> <xsl:value-of select="ubl:Invoice/cac:LegalMonetaryTotal/cbc:TaxInclusiveAmount/@currencyID" /></td></tr>
